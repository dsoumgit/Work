...
const renderButtons = (page, numResults, resPerPage) => {
    ...
    // only show when there are more than 10 items 
    if (button) {
...
export const renderList = (recipes, page = 1, resultPerPage = 3) => {
    ...
    // render buttons 
    renderButtons(page, recipes.products.length, resultPerPage);
}
