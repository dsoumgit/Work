            ...
            <div className="disclaimer__social">
                <ul className="social">
                    <li className="social__list">
                        <a href="https://www.linkedin.com/in/dara-soumgit-a57387106/" className="social__link">
                    ...
                    <li className="social__list">
                        <a href="https://twitter.com/DSoumgit" className="social__link">
                            <svg class="social__icon icon-linkedin" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                <title>Twitter</title>   
                    ...
                    <li className="social__list">
                        <a href="https://github.com/dsoumgit" className="social__link">
                            <svg class="social__icon icon-linkedin" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                <title>Github</title>    
